...
def calculate_Strength(FULL):
    ...
    """
    FULL["Calculated Solid Solution"] = FULL[[f"{i} fraction" for i in elements]].apply(calculate_solubility_strength, axis=1)

    FULL["Calculated Grain Boundary"] = FULL[[f"{i} fraction" for i in elements] + ["Grain Size"]].apply(calculate_jingjie, axis=1)
